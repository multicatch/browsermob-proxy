...
class FilterTest extends io.github.multicatch.bmp.proxy.test.util.ProxyResourceTest {
    @Test
    ...
    void testRequestFilterNotAddedIfJavascriptDoesNotCompile() {
        ...
        verify(mockProxy, never()).addRequestFilter(any(io.github.multicatch.bmp.filters.RequestFilter))
    }
    ...
    void testResponseFilterNotAddedIfJavascriptDoesNotCompile() {
        ...
        verify(mockProxy, never()).addResponseFilter(any(io.github.multicatch.bmp.filters.ResponseFilter))
    }
    ...
    void testCanShortCircuitRequestWithJavascript() {
        ...
        final String requestFilterJavaScript =
                ...
                var HttpObjectUtil = Java.type('io.github.multicatch.bmp.util.HttpObjectUtil');
