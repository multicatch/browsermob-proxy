...
/**
 * An {@link AdvancedHostResolver} that provides native JVM lookup using {@link java.net.InetAddress}.
 ...
 * log statement and will not raise an exception. The {@link DnsJavaResolver} provides support for cache
 * manipulation. If you absolutely need to manipulate the native JVM DNS cache, see
 * {@link NativeCacheManipulatingResolver} for details.
 */
