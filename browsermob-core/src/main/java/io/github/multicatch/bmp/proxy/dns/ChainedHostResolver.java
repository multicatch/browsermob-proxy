package io.github.multicatch.bmp.proxy.dns;
...
/**
 * An {@link AdvancedHostResolver} that applies the AdvancedHostResolver methods to multiple implementations. Methods
 ...
 * <ul>
 *     <li>{@link AdvancedHostResolver#remapHost(String, String)}</li>
 *     <li>{@link AdvancedHostResolver#remapHosts(java.util.Map)}</li>
 *     <li>{@link AdvancedHostResolver#removeHostRemapping(String)}</li>
 *     <li>{@link AdvancedHostResolver#clearHostRemappings()}</li>
 *     <li>{@link AdvancedHostResolver#setNegativeDNSCacheTimeout(int, java.util.concurrent.TimeUnit)}</li>
 *     <li>{@link AdvancedHostResolver#setPositiveDNSCacheTimeout(int, java.util.concurrent.TimeUnit)}</li>
 *     <li>{@link AdvancedHostResolver#clearDNSCache()}</li>
 * </ul>
 */
public class ChainedHostResolver implements AdvancedHostResolver {
    ...
    /**
     * Creates a ChainedHostResolver that applies {@link AdvancedHostResolver} methods to the specified resolvers
