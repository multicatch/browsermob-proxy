...
import io.github.multicatch.bmp.core.har.HarPageTimings;
...
public interface BrowserMobProxy {
     ...
     * {@link #newHar(String)}. Populates the {@link HarPageTimings#onLoad} value based on the amount of time
     ...
     * {@link HarPageTimings#onLoad} value based on the amount of time the current page has been captured.
     *
    ...
    /**
     * Stops capturing traffic in the HAR. Populates the {@link HarPageTimings#onLoad} value for the current page
     ...
     * of resolvers in a {@link ChainedHostResolver}.
     *
