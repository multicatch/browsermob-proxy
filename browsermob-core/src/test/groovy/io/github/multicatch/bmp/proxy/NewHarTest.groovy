 ...
 */
class NewHarTest extends io.github.multicatch.bmp.proxy.test.util.MockServerTest {
    ...
    void testDnsTimingPopulated() {
        ...
        io.github.multicatch.bmp.proxy.dns.AdvancedHostResolver mockResolver = mock(io.github.multicatch.bmp.proxy.dns.AdvancedHostResolver.class);
        ...
        io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.getNewHttpClient(proxyPort).withCloseable {
            String responseBody = io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.toStringAndClose(it.execute(new HttpGet("http://localhost:${mockServerPort}/testDnsTimingPopulated")).getEntity().getContent());
            assertEquals("Did not receive expected response from mock server", "success", responseBody);
        };

        Thread.sleep(500)
        io.github.multicatch.bmp.core.har.Har har = proxy.getHar();
        ...
        io.github.multicatch.bmp.core.har.HarEntry entry = Iterables.get(har.getLog().getEntries(), 0);
    ...
    void testCaptureResponseCookiesInHar() {
        ...
        io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.getNewHttpClient(proxy.port).withCloseable {
            String responseBody = io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.toStringAndClose(it.execute(new HttpGet("https://localhost:${mockServerPort}/testCaptureResponseCookiesInHar")).getEntity().getContent());
            assertEquals("Did not receive expected response from mock server", "success", responseBody);
        };
        ...
        io.github.multicatch.bmp.core.har.HarCookie maxAgeCookie = har.getLog().getEntries().first().response.cookies[0]
        io.github.multicatch.bmp.core.har.HarCookie expiresCookie = har.getLog().getEntries().first().response.cookies[1]
    ...
    void testCaptureResponseHeaderInHar() {
        ...
        io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.getNewHttpClient(proxy.port).withCloseable {
            String responseBody = io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.toStringAndClose(it.execute(new HttpGet("http://localhost:${mockServerPort}/testCaptureResponseHeaderInHar")).getEntity().getContent());
            assertEquals("Did not receive expected response from mock server", "success", responseBody);
        };
        ...
        List<io.github.multicatch.bmp.core.har.HarNameValuePair> headers = har.getLog().getEntries().first().response.headers
        assertThat("Expected to find headers in the HAR", headers, not(empty()))

        io.github.multicatch.bmp.core.har.HarNameValuePair header = headers.find { it.name == "Mock-Header" }
    ...
    void testCaptureResponseContentInHar() {
        ...
        io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.getNewHttpClient(proxy.port).withCloseable {
            String responseBody = io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.toStringAndClose(it.execute(new HttpGet("http://localhost:${mockServerPort}/testCaptureResponseContentInHar")).getEntity().getContent());
        ...
        io.github.multicatch.bmp.core.har.HarContent content = har.getLog().getEntries().first().response.content
    ...
    void testEndHar() {
        ...
        regularHarCanCapture: {
            io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.getNewHttpClient(proxy.port).withCloseable {
                String responseBody = io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.toStringAndClose(it.execute(new HttpGet("http://localhost:${mockServerPort}/testEndHar")).getEntity().getContent());
                assertEquals("Did not receive expected response from mock server", "success", responseBody);
            };

            Thread.sleep(500)
            io.github.multicatch.bmp.core.har.Har har = proxy.endHar()
        ...
        harEmptyAfterEnd: {
            io.github.multicatch.bmp.core.har.Har emptyHar = proxy.getHar()
        ...
        harStillEmptyAfterRequest: {
            ...
            Thread.sleep(500)
            io.github.multicatch.bmp.core.har.Har stillEmptyHar = proxy.getHar()

            assertNull("Expected getHar() to return null after calling endHar()", stillEmptyHar)
        }

        newHarInitiallyEmpty: {
            io.github.multicatch.bmp.core.har.Har newHar = proxy.newHar()
        ...
        newHarCanCapture: {
            ...
            Thread.sleep(500)
            io.github.multicatch.bmp.core.har.Har populatedHar = proxy.getHar()

            assertThat("Expected to find entries in the HAR", populatedHar.getLog().getEntries(), not(empty()))

            io.github.multicatch.bmp.core.har.HarContent newContent = populatedHar.getLog().getEntries().first().response.content
    ...
    void testNewPageReturnsHarInPreviousState() {
        ...
        io.github.multicatch.bmp.core.har.Har harWithFirstPageOnly = proxy.newPage("second-page")
        ...
        Thread.sleep(500)
        io.github.multicatch.bmp.core.har.Har harWithSecondPage = proxy.getHar()
    ...
    void testCaptureHttpRequestUrlInHar() {
        ...
        io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.getNewHttpClient(proxy.port).withCloseable {
            String responseBody = io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.toStringAndClose(it.execute(new HttpGet(requestUrl)).getEntity().getContent());
            assertEquals("Did not receive expected response from mock server", "success", responseBody);
        };
    ...
    void testMitmDisabledStopsHTTPCapture() {
        ...
        httpsRequest: {
            ...
            io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.getNewHttpClient(proxy.port).withCloseable {
                String responseBody = io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.toStringAndClose(it.execute(new HttpGet(httpsUrl)).getEntity().getContent());
        ...
        httpRequest: {
            ...
            io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.getNewHttpClient(proxy.port).withCloseable {
                String responseBody = io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.toStringAndClose(it.execute(new HttpGet(httpUrl)).getEntity().getContent());
    ...
    void testHttpDnsFailureCapturedInHar() {
        io.github.multicatch.bmp.proxy.dns.AdvancedHostResolver mockFailingResolver = mock(io.github.multicatch.bmp.proxy.dns.AdvancedHostResolver)
        ...
        io.github.multicatch.bmp.core.har.HarResponse harResponse = har.log.entries[0].response
        assertNotNull("No HAR response found", harResponse)

        assertEquals("Error in HAR response did not match expected DNS failure error message", io.github.multicatch.bmp.filters.util.HarCaptureUtil.getResolutionFailedErrorMessage("www.doesnotexist.address"), harResponse.error)
        assertEquals("Expected HTTP status code of 0 for failed request", io.github.multicatch.bmp.filters.util.HarCaptureUtil.HTTP_STATUS_CODE_FOR_FAILURE, harResponse.status)
        assertEquals("Expected unknown HTTP version for failed request", io.github.multicatch.bmp.filters.util.HarCaptureUtil.HTTP_VERSION_STRING_FOR_FAILURE, harResponse.httpVersion)
        ...
        io.github.multicatch.bmp.core.har.HarTimings harTimings = har.log.entries[0].timings
    ...
    void testHttpsDnsFailureCapturedInHar() {
        ...
        assertEquals("Error in HAR response did not match expected DNS failure error message", io.github.multicatch.bmp.filters.util.HarCaptureUtil.getResolutionFailedErrorMessage("www.doesnotexist.address:443"), harResponse.error)
        assertEquals("Expected HTTP status code of 0 for failed request", io.github.multicatch.bmp.filters.util.HarCaptureUtil.HTTP_STATUS_CODE_FOR_FAILURE, harResponse.status)
        assertEquals("Expected unknown HTTP version for failed request", io.github.multicatch.bmp.filters.util.HarCaptureUtil.HTTP_VERSION_STRING_FOR_FAILURE, harResponse.httpVersion)
        assertEquals("Expected default value for headersSize for failed request", -1L, harResponse.headersSize)
        assertEquals("Expected default value for bodySize for failed request", -1L, harResponse.bodySize)
    ...
    void testHttpConnectTimeoutCapturedInHar() {
        ...
        assertEquals("Error in HAR response did not match expected connection failure error message", io.github.multicatch.bmp.filters.util.HarCaptureUtil.getConnectionFailedErrorMessage(), harResponse.error)
        assertEquals("Expected HTTP status code of 0 for failed request", io.github.multicatch.bmp.filters.util.HarCaptureUtil.HTTP_STATUS_CODE_FOR_FAILURE, harResponse.status)
        assertEquals("Expected unknown HTTP version for failed request", io.github.multicatch.bmp.filters.util.HarCaptureUtil.HTTP_VERSION_STRING_FOR_FAILURE, harResponse.httpVersion)
        assertEquals("Expected default value for headersSize for failed request", -1L, harResponse.headersSize)
        assertEquals("Expected default value for bodySize for failed request", -1L, harResponse.bodySize)
    ...
    void testHttpResponseTimeoutCapturedInHar() {
        ...
        assertEquals("Error in HAR response did not match expected response timeout error message", io.github.multicatch.bmp.filters.util.HarCaptureUtil.getResponseTimedOutErrorMessage(), harResponse.error)
        assertEquals("Expected HTTP status code of 0 for response timeout", io.github.multicatch.bmp.filters.util.HarCaptureUtil.HTTP_STATUS_CODE_FOR_FAILURE, harResponse.status)
        assertEquals("Expected unknown HTTP version for response timeout", io.github.multicatch.bmp.filters.util.HarCaptureUtil.HTTP_VERSION_STRING_FOR_FAILURE, harResponse.httpVersion)
    ...
    void testHttpsResponseTimeoutCapturedInHar() {
        ...
        assertEquals("Error in HAR response did not match expected response timeout error message", io.github.multicatch.bmp.filters.util.HarCaptureUtil.RESPONSE_TIMED_OUT_ERROR_MESSAGE, harResponse.error)
        assertEquals("Expected HTTP status code of 0 for response timeout", io.github.multicatch.bmp.filters.util.HarCaptureUtil.HTTP_STATUS_CODE_FOR_FAILURE, harResponse.status)
        assertEquals("Expected unknown HTTP version for response timeout", io.github.multicatch.bmp.filters.util.HarCaptureUtil.HTTP_VERSION_STRING_FOR_FAILURE, harResponse.httpVersion)
        assertEquals("Expected default value for headersSize for response timeout", -1L, harResponse.headersSize)
        assertEquals("Expected default value for bodySize for response timeout", -1L, harResponse.bodySize)
