...
class BindAddressTest extends io.github.multicatch.bmp.proxy.test.util.MockServerTest {
    ...
    void testClientBindAddress() {
        ...
        io.github.multicatch.bmp.proxy.test.util.NewProxyServerTestUtil.getNewHttpClient(proxy.getPort()).withCloseable {
